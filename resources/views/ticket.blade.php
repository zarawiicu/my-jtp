...
@section('content')
                    ...
                    <div class="col-lg-12">
                        <div class="caption">
                            ...
                            <div class="main-button-red">
                                <div class="scroll-to-section"><a href="{{ route('profile-group') }}">Find Out More</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="contact-us" id="contact">
        <div class="container">
            <div class="row">
                <div class="col-lg-9 align-self-center ml-4" style="margin-left:15%">
                    <div class="row">
        ...
        <option value="9">BATU LOVE GARDEN</div>
            ...
            <div class="col-lg-12">
                ...
                <div class="col-lg-12">
                    <div class="form-group"><label class="col-sm-2 control-label required"
                        ...
                        <div class="col-sm-10">
                            <input autocomplete="off" name="Booking[booking_contact_email]"
                                id="Booking_booking_contact_email" class="form-control" type="email" />
                ...
                <div class="col-lg-12">
                    <div class="form-group"><label class="col-sm-3 control-label required"
                            for="Booking_booking_contact_country">Choose Your Country <span
                                class="required">*</span></label>
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        <label class="step-desc">Choose Your City</label>
            ...
            <div style="text-align: right; margin-bottom: 20px;" class="form-actions"><button id="bookBtn"
                    class="btn btn-primary btn-lg w-full" type="submit" name="yt0">Book
                    Now</button></div>
            </form>
